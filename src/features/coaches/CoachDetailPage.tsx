...
const CoachDetailPage = () => {
  ...
  if(isError || !coach){
    ...
    <div className="min-h-screen bg-gray-50 py-20 text-center">
        ...
        <p className="text-[#8A96A3] mt-2">Aradığın antrenör bulunamadı.</p>
          ...
          <div className="px-8 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                <h2 className="text-xl font-bold text-[#0B1628] border-b border-gray-100 pb-2 mb-4">About Me</h2>
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-100 h-fit">
                <h3 className="font-bold text-[#0B1628] mb-4 uppercase tracking-wide text-sm">Quick Facts</h3>
                
                <div className="space-y-4 text-sm">
                  <div>
                    <p className="text-[#8A96A3] mb-1">Hourly Rate</p>
                    <p className="font-bold text-[#0D6E6E] text-lg">₺{coach.hourlyRate}</p>
                  </div>
                  
                  <div>
                    <p className="text-[#8A96A3] mb-1">Experience</p>
                    <p className="font-semibold text-[#3D4A5C]">{coach.experience} Years</p>
                  </div>

                  <div>
                    <p className="text-[#8A96A3] mb-1">Location</p>
                  ...
                  <div>
                    <p className="text-[#8A96A3] mb-1">Rating</p>
